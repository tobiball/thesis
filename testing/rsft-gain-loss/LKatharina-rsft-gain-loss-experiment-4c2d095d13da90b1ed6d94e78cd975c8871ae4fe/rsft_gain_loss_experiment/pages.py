...
class NewBlock(Page):
  def is_displayed(self):
    return (self.player.phase in ['positive_gain', "positive_loss", "negative_gain", "negative_loss"])
  form_model = 'player'
  def vars_for_template(self):
    context = self.player.vars_for_template()
    p = self.player
...
class Choices(Page):
  def is_displayed(self):
    return (self.player.phase in ['familiarization_gain',"familiarization_loss", 'positive_gain', "positive_loss", "negative_gain", "negative_loss"])
  form_model = 'player'
