...
# CHANGE THIS
# 1. General setup ----------------------------------------------------------
phases  = ["familiarization_gain", "familiarization_loss", "positive_gain", "negative_gain", "positive_loss", "negative_loss"]
"""String: Name or names of phases to change the stimulus material (see below) """

blocks  = [1,1,3,3,3,3] # 1,1,3,3,3,3
