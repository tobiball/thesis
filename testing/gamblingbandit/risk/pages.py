...
class End(Page):
    ...
    def app_after_this_page(self, upcoming_apps):
        if self.participant.vars['treatment'] == 'one':
            return "game_instructions_t0"
        if self.participant.vars['treatment'] == 'two':
            return "game_instructions_t2"
# ******************************************************************************************************************** #
# *** PAGE SEQUENCE *** #
# ******************************************************************************************************************** #
page_sequence = [Instructions, Decision, End]
