...
class Player(BasePlayer):
    ...
    quiz2 = models.IntegerField(
        choices=[[1, "Shamrock at the left"], [2, "Coin at the right"], [3, "Lemon at both"]],
        label='What is your win condition?',
        widget=widgets.RadioSelect,
    )
    quiz3 = models.IntegerField(
        choices=[[1, "The wheels stop randomly"], [2, "The STOP-button influences the wheels"], [3, "The picture of the first wheel influences the second wheel"]],
        label='What determines the picture of the wheels?',
        widget=widgets.RadioSelect,
    )
